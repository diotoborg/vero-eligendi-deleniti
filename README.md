...
[![CI status](https://github.com/diotoborg/vero-eligendi-deleniti/workflows/Node.js%20CI/badge.svg)](https://github.com/diotoborg/vero-eligendi-deleniti/actions?query=workflow%3A%22Node.js+CI%22)
[![Coverage Status](https://coveralls.io/repos/github/seriousme/@diotoborg/vero-eligendi-deleniti/badge.svg?branch=master)](https://coveralls.io/github/seriousme/@diotoborg/vero-eligendi-deleniti?branch=master)
[![NPM version](https://img.shields.io/npm/v/@diotoborg/vero-eligendi-deleniti.svg)](https://www.npmjs.com/package/@diotoborg/vero-eligendi-deleniti)
![npm](https://img.shields.io/npm/dm/@diotoborg/vero-eligendi-deleniti)
...
If you are upgrading from a previous major version of `@diotoborg/vero-eligendi-deleniti` then please check out [UPGRADING.md](UPGRADING.md).

<a name="install"></a>
## Install 
```
npm i @diotoborg/vero-eligendi-deleniti --save
```
<a name="plugin"></a>
## Plugin
...
```javascript
import openapiGlue from "@diotoborg/vero-eligendi-deleniti";
...
```
  npx github:seriousme/@diotoborg/vero-eligendi-deleniti <OpenApi specification>
```
